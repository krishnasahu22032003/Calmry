...
const toastVariants = cva(
  ...
  backdrop-blur-[24px]
  p-6 pr-8
  shadow-[0_32px_90px_rgba(0,0,0,0.8)]
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      group-[.destructive]:border-(--accent-warm)/40
      group-[.destructive]:hover:bg-(--accent-warm)/20
      `,
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    className={cn(
      ...
      group-[.destructive]:text-(--accent-warm)
      `,
      className
    )}
    toast-close=""
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn("text-sm text-muted leading-relaxed opacity-90", className)}
    {...props}
  />
));
